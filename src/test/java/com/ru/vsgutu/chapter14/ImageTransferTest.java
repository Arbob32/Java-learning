...
import com.ru.vsgutu.chapter14.a.ImageTransferServer;
import java.io.*;
import java.net.*;
...
public class ImageTransferTest {
    ...
    private static final int TEST_PORT = 4554;
    private static final Path TEST_IMAGE_PATH = Path.of("src/test/resources/test_image.png");
    private static final Path RECEIVED_IMAGE_PATH =
            Path.of("src/test/resources/received_image.png");
    ...
    void testServerClientFileTransfer() throws IOException, InterruptedException {
        ...
        assertArrayEquals(
                Files.readAllBytes(TEST_IMAGE_PATH),
                Files.readAllBytes(RECEIVED_IMAGE_PATH),
